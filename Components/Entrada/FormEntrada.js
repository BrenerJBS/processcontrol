...
const FormEntrada = ({handleSubmit,processos, setProcessos,processo,dataEntrada, setDataEntrada, requerente, setRequerente, assuntos, assunto, setAssunto, auditores, auditor,setAuditor,prioridade,setPrioridade,notificacao,setNotificacao,refInput,obs,setObs,edit,handleSubmitCancelar,loadingbutton,handleSubmitEditar, error}) => {
  return (
      ...
      <div className={styles.row}>
        ...
        <div className={styles.col75} >
          ...
          {edit ? 
            ...
            <>{loadingbutton ? <button className={stylesB.button} onClick={handleSubmitEditar} disable>Carregando...</button> : <button className={stylesB.button} onClick={handleSubmitEditar}>Enviar</button>}     
            <Error error={error} /></>
            ...
            {loadingbutton ? <ButtonForm disable>Carregando...</ButtonForm> : <ButtonForm>Enviar</ButtonForm>}     
            <Error error={error} />
             </div>}
      </div>
      </form>
